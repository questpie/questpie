...
GitHub reports both native blockers #288 and #301 closed and labels #289
`ready-for-agent`. The accepted foundation includes:
...
```text
Use the repo-owned QUESTPIE v4 skill. Implement and accept BETA-02 issue #289
without widening its schema/migration/Seed tracer. Continue the original N=5
queue only after #289 passes deterministic gates, fresh stateless Opus-medium
review, PR/CI, merge, and tracker acceptance. Preserve the marketing worktree
and archive branch.
```
