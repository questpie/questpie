...
These guidelines reduce common LLM coding mistakes. Merge them with the project-specific instructions below as needed. They bias toward caution over speed; for trivial tasks, use judgment.
