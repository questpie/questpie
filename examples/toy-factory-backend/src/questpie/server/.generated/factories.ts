...
declare global {
	namespace Questpie {
		...
		interface JobKeys {
			recalculateMaterialPlan: unknown;
		}
		interface RouteKeys {
			"rpc/planning/capacitySummary": unknown;
			"rpc/planning/receiveMaterials": unknown;
			"rpc/planning/startProduction": unknown;
		}
		interface ServiceKeys {
			capacityPlanner: unknown;
		}
		interface EmailKeys {
			productionScheduled: unknown;
		}
		interface WorkflowKeys {
			nightlyCapacityReview: unknown;
			productionOrderPlan: unknown;
		}
	}
}
