...
import { C as ChartWidgetSkeleton } from "./widget-skeletons-i0KIuI2-.js";
import clsx from "clsx";
import { j as commonjsGlobal, k as getDefaultExportFromCjs } from "./router-DfekICpe.js";
import { i as invariant } from "../index.js";
...
function require_baseIteratee() {
  ...
  var baseMatches = require_baseMatches(), baseMatchesProperty = require_baseMatchesProperty(), identity4 = requireIdentity(), isArray = requireIsArray(), property = requireProperty();
...
function require_baseOrderBy() {
  ...
  var arrayMap = require_arrayMap(), baseGet = require_baseGet(), baseIteratee = require_baseIteratee(), baseMap = require_baseMap(), baseSortBy = require_baseSortBy(), baseUnary = require_baseUnary(), compareMultiple = require_compareMultiple(), identity4 = requireIdentity(), isArray = requireIsArray();
...
var _defineProperty$G;
var hasRequired_defineProperty;
function require_defineProperty() {
  if (hasRequired_defineProperty) return _defineProperty$G;
  ...
  _defineProperty$G = defineProperty;
  ...
  var chartContent = useMemo(function() {
    ...
    return React__default.Children.map(children, function(child) {
      if (/* @__PURE__ */ React__default.isValidElement(child)) {
        return /* @__PURE__ */ cloneElement(child, _objectSpread$x({
...
var Curve = function Curve2(props) {
  ...
  return /* @__PURE__ */ React.createElement("path", _extends$l({}, filterProps(props, false), adaptEventHandlers(props), {
...
function requireReactIs_production_min() {
  ...
  var b = "function" === typeof Symbol && Symbol.for, c2 = b ? /* @__PURE__ */ Symbol.for("react.element") : 60103, d = b ? /* @__PURE__ */ Symbol.for("react.portal") : 60106, e = b ? /* @__PURE__ */ Symbol.for("react.fragment") : 60107, f = b ? /* @__PURE__ */ Symbol.for("react.strict_mode") : 60108, g = b ? /* @__PURE__ */ Symbol.for("react.profiler") : 60114, h = b ? /* @__PURE__ */ Symbol.for("react.provider") : 60109, k2 = b ? /* @__PURE__ */ Symbol.for("react.context") : 60110, l = b ? /* @__PURE__ */ Symbol.for("react.async_mode") : 60111, m = b ? /* @__PURE__ */ Symbol.for("react.concurrent_mode") : 60111, n = b ? /* @__PURE__ */ Symbol.for("react.forward_ref") : 60112, p = b ? /* @__PURE__ */ Symbol.for("react.suspense") : 60113, q = b ? /* @__PURE__ */ Symbol.for("react.suspense_list") : 60120, r = b ? /* @__PURE__ */ Symbol.for("react.memo") : 60115, t = b ? /* @__PURE__ */ Symbol.for("react.lazy") : 60116, v = b ? /* @__PURE__ */ Symbol.for("react.block") : 60121, w = b ? /* @__PURE__ */ Symbol.for("react.fundamental") : 60117, x2 = b ? /* @__PURE__ */ Symbol.for("react.responder") : 60118, y2 = b ? /* @__PURE__ */ Symbol.for("react.scope") : 60119;
  function z(a2) {
    if ("object" === typeof a2 && null !== a2) {
      var u = a2.$$typeof;
      switch (u) {
...
var Animate = /* @__PURE__ */ (function(_PureComponent) {
  _inherits$e(Animate2, _PureComponent);
  var _super = _createSuper(Animate2);
  function Animate2(props, context) {
    var _this;
    _classCallCheck$g(this, Animate2);
    ...
    _this.handleStyleChange = _this.handleStyleChange.bind(_assertThisInitialized$e(_this));
    _this.changeStyle = _this.changeStyle.bind(_assertThisInitialized$e(_this));
  ...
  _createClass$g(Animate2, [{
    ...
    value: function render() {
      ...
      var cloneContainer = function cloneContainer2(container) {
        ...
        var res = /* @__PURE__ */ cloneElement(container, _objectSpread$m(_objectSpread$m({}, others), {}, {
...
var Dot = function Dot2(props) {
  ...
  if (cx === +cx && cy === +cy && r === +r) {
    return /* @__PURE__ */ React.createElement("circle", _extends$i({}, filterProps(props, false), adaptEventHandlers(props), {
      className: layerClass,
      cx,
      cy,
      r
...
var PolarRadiusAxis = /* @__PURE__ */ (function(_PureComponent) {
  ...
  return _createClass$f(PolarRadiusAxis2, [{
    ...
    value: function renderTicks() {
      var _this = this;
      var _this$props4 = this.props, ticks2 = _this$props4.ticks, tick = _this$props4.tick, angle = _this$props4.angle, tickFormatter = _this$props4.tickFormatter, stroke = _this$props4.stroke, others = _objectWithoutProperties$8(_this$props4, _excluded2$5);
...
function Shape(_ref2) {
  ...
  var shape;
  if (/* @__PURE__ */ isValidElement(option)) {
    shape = /* @__PURE__ */ cloneElement(option, _objectSpread$g(_objectSpread$g({}, props), getPropsFromShapeOption(option)));
  } else if (isFunction(option)) {
    shape = option(props);
...
var minPointSizeCallback = function minPointSizeCallback2(minPointSize) {
  ...
  return function(value, index) {
    ...
    !isValueNumberOrNil ? process.env.NODE_ENV !== "production" ? invariant(false, "minPointSize callback function received a value with type of ".concat(_typeof$g(value), ". Currently only numbers or null/undefined are supported.")) : invariant(false) : void 0;
    return defaultValue;
  };
};
...
var useXAxisOrThrow = function useXAxisOrThrow2(xAxisId) {
  ...
  !(xAxis != null) ? process.env.NODE_ENV !== "production" ? invariant(false, 'Could not find xAxis by id "'.concat(xAxisId, '" [').concat(_typeof$d(xAxisId), "]. ").concat(getKeysForDebug(xAxisMap))) : invariant(false) : void 0;
  return xAxis;
};
...
var useYAxisOrThrow = function useYAxisOrThrow2(yAxisId) {
  ...
  !(yAxis != null) ? process.env.NODE_ENV !== "production" ? invariant(false, 'Could not find yAxis by id "'.concat(yAxisId, '" [').concat(_typeof$d(yAxisId), "]. ").concat(getKeysForDebug(yAxisMap))) : invariant(false) : void 0;
  return yAxis;
};
...
function CartesianGrid(props) {
  ...
  if ((!horizontalPoints || !horizontalPoints.length) && isFunction(horizontalCoordinatesGenerator)) {
    ...
    warn$1(Array.isArray(generatorResult), "horizontalCoordinatesGenerator should return Array but instead it returned [".concat(_typeof$7(generatorResult), "]"));
  ...
  if ((!verticalPoints || !verticalPoints.length) && isFunction(verticalCoordinatesGenerator)) {
    ...
    warn$1(Array.isArray(_generatorResult), "verticalCoordinatesGenerator should return Array but instead it returned [".concat(_typeof$7(_generatorResult), "]"));
...
function ChartTooltip({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "rounded-md border border-border bg-background px-3 py-2 text-xs shadow-md", children: [
    /* @__PURE__ */ jsx("p", { className: "font-medium text-foreground", children: label }),
    payload.map((entry) => /* @__PURE__ */ jsxs("p", { className: "text-muted-foreground", children: [
      entry.name,
      ":",
      " ",
      /* @__PURE__ */ jsx("span", { className: "font-medium text-foreground", children: entry.value })
    ] }, String(entry.name)))
  ] });
}
function ChartWidget({ config: config2 }) {
  ...
  const {
    ...
    timeRange = "30d",
    label,
    color: color2 = "var(--color-chart-1)",
    showGrid = true,
    realtime,
    hasFetchFn,
    refreshInterval
  } = config2;
  const serverQuery = useServerWidgetData(config2.id, {
    enabled: !!hasFetchFn,
    refreshInterval
  });
  ...
  const { isLoading, error, refetch } = hasFetchFn ? serverQuery : collectionQuery;
  const collectionItems = hasFetchFn ? [] : Array.isArray(collectionQuery.data?.docs) ? collectionQuery.data.docs : [];
  ...
  const chartData = React.useMemo(() => {
    ...
    const grouped = collectionItems.reduce(
      (acc, item) => {
        ...
        if (value instanceof Date || !isNaN(Date.parse(value))) {
          ...
          key = formatDateForRange(date2, timeRange);
        } else {
          key = String(value);
        }
        acc[key] = (acc[key] || 0) + 1;
    ...
    return Object.entries(grouped).map(([name, value]) => ({ name, value })).sort((a2, b) => a2.name.localeCompare(b.name));
  }, [hasFetchFn, serverQuery.data, collectionItems, field, timeRange]);
  const emptyContent = /* @__PURE__ */ jsx("div", { className: "flex h-48 items-center justify-center text-muted-foreground", children: /* @__PURE__ */ jsx("p", { className: "text-sm", children: "No data available" }) });
  const chartContent = chartData.length === 0 ? emptyContent : /* @__PURE__ */ jsx("div", { className: "h-48 w-full", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: renderChart(chartType, chartData, color2, showGrid) }) });
  return /* @__PURE__ */ jsx(
    WidgetCard,
    {
      title: displayLabel,
...
function renderChart(type, data, color2, showGrid) {
  const commonProps = {
    data,
  ...
  switch (type) {
    case "line":
      return /* @__PURE__ */ jsxs(LineChart, { ...commonProps, children: [
        ...
        /* @__PURE__ */ jsx(YAxis, { tick: axisStyle, tickLine: false, axisLine: false }),
    ...
    case "bar":
      return /* @__PURE__ */ jsxs(BarChart, { ...commonProps, children: [
        ...
        /* @__PURE__ */ jsx(Bar, { dataKey: "value", fill: color2, radius: [2, 2, 0, 0] })
      ] });
    case "pie":
      return /* @__PURE__ */ jsxs(PieChart, { children: [
        /* @__PURE__ */ jsx(
          Pie,
          {
            ...
            strokeWidth: 2,
            children: data.map((entry) => /* @__PURE__ */ jsx(
              Cell,
              {
...
function formatDateForRange(date2, timeRange) {
  const months = [
    "Jan",
    "Feb",
    "Mar",
  ...
  switch (timeRange) {
    case "7d": {
      ...
      return `${days[date2.getDay()]} ${date2.getDate()}`;
    }
    case "30d":
      return `${months[date2.getMonth()]} ${date2.getDate()}`;
    case "90d": {
      const weekNum = Math.ceil(date2.getDate() / 7);
      return `W${weekNum} ${months[date2.getMonth()]}`;
    }
    case "1y":
