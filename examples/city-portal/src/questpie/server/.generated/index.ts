...
import { createApp, createContextFactory, extractAppServices, type AppDefinition, type Questpie, type AppContext, type Registry, type QuestpieConfig, type QueueClient, type CollectionAPI, type GlobalAPI } from "questpie";
...
type _GlobalsAPI = { [K in keyof AppGlobals]: GlobalAPI<AppGlobals[K], AppCollections> };
