 ...
 */
export type CollectionDoc<K extends keyof AppCollections> = CollectionSelect<
	AppCollections[K]
>;
 ...
 */
export type CollectionWhere<K extends keyof AppCollections> = Where<
	AppCollections[K],
	AppConfig
>;
 ...
 * ```
 */
export type AccessRuleContext<
	K extends keyof AppCollections | unknown = unknown,
...
var _appLease = acquireGeneratedApp(
	"tanstack-barbershop-example:src/questpie/server:src/questpie/server/questpie.config.ts",
	() =>
		createApp(
			{
				modules: _modules,
				...
				migrations: [
					_mig_20260206T174642_gentle_azure_eagle,
					_mig_20260206T180920_fancy_green_tiger,
					_mig_20260211T100836_calm_blue_phoenix,
					_mig_20260218T195452_calm_blue_dragon,
					_mig_20260218T223923_fancy_blue_panda,
					_mig_20260218T235924_kind_crimson_falcon,
					_mig_20260307T122102_eager_red_eagle,
					_mig_20260307T135142_fancy_orange_tiger,
					_mig_20260424T221327_bold_yellow_phoenix,
					_mig_20260427T093217_eager_blue_phoenix,
					_mig_20260429T170546_kind_yellow_eagle,
					_mig_20260615T084209_swift_orange_eagle,
					_mig_20260712T094709_bold_red_griffin,
					_mig_20260712T195414_eager_red_tiger,
...
const _hot = (
	import.meta as ImportMeta & {
		hot?: { dispose(callback: () => void | Promise<void>): void };
	}
).hot;
