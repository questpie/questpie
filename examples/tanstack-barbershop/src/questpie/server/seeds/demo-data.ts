		...
		const barber1 = await collections.barbers.create(
			{
				...
				workingHours: {
					monday: { isOpen: true, start: "09:00:00", end: "18:00:00" },
					tuesday: { isOpen: true, start: "09:00:00", end: "18:00:00" },
					wednesday: { isOpen: true, start: "09:00:00", end: "18:00:00" },
					thursday: { isOpen: true, start: "09:00:00", end: "20:00:00" },
					friday: { isOpen: true, start: "09:00:00", end: "20:00:00" },
					saturday: { isOpen: true, start: "10:00:00", end: "16:00:00" },
		...
		const barber2 = await collections.barbers.create(
			{
				...
				workingHours: {
					monday: { isOpen: true, start: "11:00:00", end: "19:00:00" },
					tuesday: { isOpen: true, start: "11:00:00", end: "19:00:00" },
					wednesday: { isOpen: true, start: "11:00:00", end: "19:00:00" },
					thursday: { isOpen: true, start: "11:00:00", end: "21:00:00" },
					friday: { isOpen: true, start: "11:00:00", end: "21:00:00" },
					saturday: { isOpen: true, start: "10:00:00", end: "16:00:00" },
					sunday: { isOpen: false, start: null, end: null },
				},
			},
		...
		const barber3 = await collections.barbers.create(
			{
				...
				workingHours: {
					monday: { isOpen: true, start: "08:00:00", end: "16:00:00" },
					tuesday: { isOpen: true, start: "08:00:00", end: "16:00:00" },
					wednesday: { isOpen: true, start: "08:00:00", end: "16:00:00" },
					thursday: { isOpen: true, start: "08:00:00", end: "16:00:00" },
					friday: { isOpen: true, start: "08:00:00", end: "16:00:00" },
		...
		const barber4 = await collections.barbers.create(
			{
				...
				workingHours: {
					monday: { isOpen: true, start: "10:00:00", end: "18:00:00" },
					tuesday: { isOpen: true, start: "10:00:00", end: "18:00:00" },
					wednesday: { isOpen: false, start: null, end: null },
					thursday: { isOpen: true, start: "10:00:00", end: "18:00:00" },
					friday: { isOpen: true, start: "10:00:00", end: "20:00:00" },
					saturday: { isOpen: true, start: "09:00:00", end: "15:00:00" },
					sunday: { isOpen: false, start: null, end: null },
				},
			},
			ctxEn,
