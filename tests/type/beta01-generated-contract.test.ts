...
describe("BETA-01 generated contract", () => {
	test("compiles the relocated collaboration fixture byte-identically", async () => {
		...
		expect(Object.keys(first.generatedFiles).sort()).toEqual([
			...
			"internal/application-2debdssm.js",
			"internal/application-46m92t59.js",
			"internal/application-7007f1d6.js",
			"internal/application-d787d2b8.js",
			"internal/application-eknbdqvg.js",
			"internal/application-ezjrd6hh.js",
			"internal/application-gjea68mp.js",
