...
describe("BETA-01 generated contract", () => {
	test("compiles the relocated collaboration fixture byte-identically", async () => {
		...
		expect(Object.keys(first.generatedFiles).sort()).toEqual([
			...
			"internal/application-jar51jna.js",
			"internal/application-m2pxg3k3.js",
			"internal/application-p4gtc9n9.js",
			"internal/application-rphd2gwb.js",
			"internal/application-rsc9pf9v.js",
			"internal/application-s2vptppc.js",
			"internal/application-xx8fn0k7.js",
		...
		expect(
			...
			"collection:spaces",
			"context:app.context",
			"credentialResolver:collaboration.credentials",
			"mutation:message.publish",
			"mutation:message.recordDelivery",
