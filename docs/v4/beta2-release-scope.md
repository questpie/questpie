...
| Aggregate release                                                | release tooling                            | two same-version tarballs and release manifest                         | relocated clean consumer            | PostgreSQL/browser, `quality:release`, two byte-identical dry-runs             | two-package migration pending; beta.2 remains blocked by MCP and skill     |
