...
| Native React Query integration                                   | `questpie/react-query`                     | generated native options, optional React/TanStack peers, identity bootstrap | Team Support Desk and native Start  | lifetime, invalidation, Suspense/infinite, SSR/hydration, credential retirement, packed tutorials                  | complete through NRQ-05; final aggregate gates pending                          |
