...
| Direct and network routing              | `tests/load/beta10-ten-instance.ts:33`–`:69`.                                                                                                                                                                                                                            | 20 direct roots and 20 POSTs succeeded across ten instances.                                                                                                                |
| Concurrent durable workers              | `tests/load/beta10-ten-instance.ts:71`–`:112`; the established 64-run contention workload remains at `tests/load/beta08-worker-contention.ts:54`–`:103`.                                                                                                                 | 40/40 in BETA-10 and 64/64 in the inherited contention case, with zero duplicate attempts.                                                                                  |
