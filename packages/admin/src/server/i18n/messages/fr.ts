...
export default {
	...
	"action.itemIdRequired.resetPassword":
		"L'ID de l'utilisateur est requis pour la réinitialisation du mot de passe",
	...
	"audit.action.purge": "a supprimé définitivement",
	...
	"field.reorder": "Glisser pour réordonner",
