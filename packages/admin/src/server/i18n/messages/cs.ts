...
export default {
	...
	"action.itemIdRequired.resetPassword":
		"Pro resetování hesla je vyžadováno ID uživatele",
	...
	"defaults.users.fields.role.description":
		"Administrátoři mohou spravovat celou administraci; uživatelé mají omezený přístup.",
	...
	"defaults.users.fields.banExpires.description":
		"Kdy má blokace uživatele vypršet",
	...
	"defaults.assets.fields.caption.description":
		"Volitelný popisek zobrazený u média",
