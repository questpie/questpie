...
export default {
	...
	"oauth.consentTitle": "Authorize access",
	"oauth.consentIntro": "{{app}} is requesting access to your account.",
	"oauth.consentPermissionsLabel": "This will allow it to",
	"oauth.consentNoScopes": "No specific permissions were requested.",
	"oauth.consentAllow": "Allow",
	"oauth.consentDeny": "Deny",
	"oauth.consentUnknownApp": "An application",
	"oauth.consentInvalidRequest":
		"This authorization request is invalid or has expired. Start again from the application you were connecting.",
	"oauth.consentBackToAdmin": "Back to admin",
	"oauth.consentNoAuthClient":
		"Unable to process the request — the auth client is unavailable.",
	"oauth.consentFailed": "Could not complete authorization. Please try again.",
