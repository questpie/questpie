...
const ICONS = {
  ...
  plug: (
    <path d="M9 2v6m6-6v6M5 8h14v3a7 7 0 0 1-14 0V8Zm7 10v4" />
  ),
  spark: (
  ...
  store: (
    <path d="M4 8 5.5 3h13L20 8m-16 0v12h16V8M4 8h16M10 13h4v7h-4z" />
  ),
  ...
  chat: (
    <path d="M21 12a8 8 0 1 1-3.4-6.5L21 4l-1.5 3.4A8 8 0 0 1 21 12Z" />
  ),
  branch: (
    <>
...
function Mark({ size = 22, accent = "var(--primary)", outline = "currentColor" }) {
  return (
    <svg
      width={size}
      height={size}
...
/* ---------- Section heading ---------- */
function SectionHeading({ eyebrow, eyebrowColor, title, lede, align = "left", titleSize }) {
  return (
    <div
      style={{
        textAlign: align,
    ...
    >
      {eyebrow && (
        <div style={{ marginBottom: 14 }}>
          <Eyebrow dot color={eyebrowColor}>{eyebrow}</Eyebrow>
        </div>
      )}
      <h2
        style={{
