	...
	return (
		...
		>
			...
			>
				...
				<Lbl
					label="Error state"
					hint="Border + helper text use destructive, never decorative."
				>
					<input
						placeholder="email@…"
						style={{
					...
					/>
					<span style={{ fontSize: 11.5, color: "var(--destructive)" }}>
						Email is required.
					</span>
				</Lbl>
			...
			>
				...
				<div className="panel" style={{ padding: 20 }}>
					<window.Icon
						name="rocket"
						size={18}
						style={{ color: "var(--pillar-cloud)", marginBottom: 14 }}
					/>
					<div
						style={{
							fontSize: 15,
				...
				>
					<window.Icon
						name="search"
						size={20}
						style={{ color: "var(--foreground-subtle)", marginBottom: 10 }}
					/>
					<div
						style={{
							fontSize: 14,
	...
	return (
		...
		>
			...
			{badge && (
				<span
					className="mono tabular"
					style={{ fontSize: 10.5, color: "var(--foreground-subtle)" }}
				>
					{badge}
				</span>
			)}
					...
					>
						...
						<span
							style={{
								...
								background: "transparent",
								border: "2px solid",
								borderColor: SC[i.status],
								opacity: i.status === "done" ? 1 : 0.95,
								position: "relative",
							}}
						>
							{i.status === "in_progress" && (
								<span
									style={{
										...
										inset: 0,
										borderRadius: "50%",
										background: `conic-gradient(${SC[i.status]} 50%, transparent 0)`,
									}}
								/>
							)}
							{i.status === "done" && (
		...
		>
			...
			>
					...
					<div style={{ marginTop: 22 }}>
						...
						{[
							[
								"08:12",
								"Marek",
								"Created issue · attached workflow review-content",
								null,
							],
				...
				>
					...
					<PropRow
						label="Type"
						value={<span style={{ fontSize: 12.5 }}>Feature</span>}
					/>
					<PropRow
						label="Project"
						value={<span style={{ fontSize: 12.5 }}>Marketing site</span>}
					/>
					<PropRow
						label="Workflow"
						value={
							<code
								style={{ fontSize: 11.5, color: "var(--pillar-autopilot)" }}
							>
								review-content
							</code>
						}
					...
					<PropRow
						label="Assignee"
						value={<span style={{ fontSize: 12.5 }}>@marek</span>}
					/>
					<PropRow
						label="Created"
						value={
			...
			>
				<div style={{ display: "flex", flexDirection: "column" }}>
					...
					>
						<Bubble
							who="agent"
							text="Drafted the announcement. 612 words, brand tone, embedded the Q3 metric callouts."
							diff={["+ Hero copy", "+ Pricing block", "~ CTA wording"]}
						/>
						<Bubble
							who="user"
							text="Tighten the hero, drop the founder quote."
						/>
						<Bubble
							who="agent"
							text="Done. Tightened hero (-38 words), removed founder quote. Preview ready."
						/>
					</div>
					<div
						style={{
				...
				>
					...
					<div>
						...
						{["collections.posts", "knowledge.search", "cloud.deploy"].map(
							(t) => (
								<div
									key={t}
									className="mono"
