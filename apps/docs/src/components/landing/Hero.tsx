				...
				<div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
					...
					<div>
						...
						<p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-4 max-w-lg">
							...
							<code className="text-primary font-mono text-base bg-primary/10 px-1">.admin()</code>{" "}
							<code className="text-primary font-mono text-base bg-primary/10 px-1">.list()</code>{" "}
							<code className="text-primary font-mono text-base bg-primary/10 px-1">.form()</code>.
