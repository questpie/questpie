			...
			<div className="w-full max-w-7xl mx-auto px-4 relative z-10">
				...
				<div className="text-center max-w-2xl mx-auto space-y-4 mb-16">
					...
					<p className="text-muted-foreground">
						Schema, validation, admin config, access rules — everything lives on the server. The client is a thin layer that reads config and applies your branding. Change once, everything updates.
					</p>
				</div>
				...
				<div className="grid lg:grid-cols-2 gap-6 mb-12">
					<div className="space-y-3">
						...
						<CodeWindow title="server/collections/posts.ts">{serverCode}</CodeWindow>
					</div>
