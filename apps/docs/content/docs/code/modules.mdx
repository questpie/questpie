...
A module is a plain object. `module()` is an identity function. It returns your
object unchanged, so it costs nothing at runtime. It is there to check the shape
and carry your object's type forward.
