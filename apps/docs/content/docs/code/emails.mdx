...
- [Jobs](/docs/code/jobs), send mail off the request path in a background job.
- [Services](/docs/code/services), how `ctx.email` and other context services are resolved, and how to add your own.
