...
<Callout type="info">For usage examples and patterns, see the [Fields Guide](/docs/collections/fields).</Callout>
...
<Callout type="info">See [Query Operators Reference](/docs/reference/query-operators) for the full list of type-safe `where` clause operators by field type.</Callout>
