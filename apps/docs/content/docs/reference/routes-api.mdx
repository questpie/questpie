...
<Callout type="info">For usage examples and patterns, see the [Typed Routes Guide](/docs/server/routes).</Callout>

## `route()`

The `route()` factory creates an immutable route builder. Each method returns a new frozen instance.
