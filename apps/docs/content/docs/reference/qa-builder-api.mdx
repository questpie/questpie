...
The `AppConfig` type parameter gives autocomplete against your server schema.
...
The `AppConfig` type parameter connects the admin builder to your server schema:
