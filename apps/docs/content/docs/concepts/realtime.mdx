...
request-handling replica supports the advertised protocol, `add_topic`,
`remove_topic`, reconnect, and resume may hit any replica. Sticky affinity is a
temporary rolling-upgrade mitigation, not a steady-state HA requirement.
