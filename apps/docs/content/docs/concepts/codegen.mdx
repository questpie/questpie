...
flowchart TD
  Generated[".generated/"]
  Index["index.ts<br/>App instance, type exports, createContext helper"]
  Module["module.ts<br/>Merged module with all entities"]
...
<Cards>
  ...
  <Card title="CLI" href="/docs/reference/cli" description="CLI commands" />
  <Card title="Type Inference" href="/docs/client/type-inference" description="End-to-end type flow" />
  <Card title="Plugins" href="/docs/concepts/modules-and-plugins" description="Plugin architecture" />
</Cards>
