...
- [Collections](/docs/schema/collections#searchable), projection configuration with `.searchable()`.
- [Jobs](/docs/code/jobs), the queue-backed indexing lifecycle.
- [Search adapters](/docs/adapters/search), backend setup and operational details.
- [Access control](/docs/schema/access-control), row-level result visibility.
