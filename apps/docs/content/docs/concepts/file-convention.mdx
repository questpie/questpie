...
<Cards>
  ...
  <Card title="Modules" href="/docs/concepts/modules-and-plugins" description="Module composition" />
  <Card title="Plugins" href="/docs/concepts/modules-and-plugins" description="Plugin system" />
  <Card title="Project Structure" href="/docs/getting-started/project-structure" description="Full layout reference" />
</Cards>
