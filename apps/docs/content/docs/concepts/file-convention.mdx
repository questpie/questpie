...
- [Codegen](/docs/concepts/codegen) — What gets generated
- [Modules](/docs/concepts/modules-and-plugins) — Module composition
- [Plugins](/docs/concepts/modules-and-plugins) — Plugin system
- [Project Structure](/docs/getting-started/project-structure) — Full layout reference
