...
- **New dev (build something)**, [TanStack Start](/docs/getting-started/tanstack-start) → [Collections](/docs/schema/collections) → [Fields](/docs/concepts/fields) → [Relations](/docs/schema/relations) → [Access control](/docs/schema/access-control) → [Client SDK](/docs/client/sdk) → [TanStack Query](/docs/client/tanstack-query). Add [Hooks](/docs/schema/hooks), [Jobs](/docs/concepts/jobs), and [Routes](/docs/concepts/routes) when you need behavior.
- **Backend / data modeler**, [Collections](/docs/schema/collections) → [Fields](/docs/concepts/fields) → [Relations](/docs/schema/relations) → [Validation](/docs/schema/validation) → [Access control](/docs/schema/access-control) → [Hooks](/docs/schema/hooks).
