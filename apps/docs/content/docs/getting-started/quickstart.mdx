...
- [Project Structure](/docs/getting-started/project-structure) — File convention layout and discovery rules
- [Collections](/docs/collections) — Builder chain and server-side methods
