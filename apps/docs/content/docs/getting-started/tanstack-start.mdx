...
- **PostgreSQL 15+**, the minimum database version supported by QUESTPIE.
- **[Docker](https://www.docker.com/)**, runs local PostgreSQL 15+ (and provisions the extensions the starter needs).
