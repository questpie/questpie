...
<Callout type="info" title="`#questpie/factories`, not `questpie`">
	...
	[Collections](/docs/schema/collections) for the full builder.
</Callout>
...
- [Collections](/docs/schema/collections), fields, relations, hooks, access, and the admin views they generate.
