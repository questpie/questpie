...
<Cards>
  <Card title="Collections" href="/docs/collections" description="Define your data models" />
  <Card title="Fields" href="/docs/collections/fields" description="Field types and options" />
  <Card title="File Convention" href="/docs/concepts/file-convention" description="Deep dive into discovery mechanics" />
</Cards>
