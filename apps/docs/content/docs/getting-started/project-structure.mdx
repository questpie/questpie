...
- [Collections](/docs/collections) — Define your data models
- [Fields](/docs/collections/fields) — Field types and options
- [File Convention](/docs/concepts/file-convention) — Deep dive into discovery mechanics
