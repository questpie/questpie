...
- [Getting Started](/docs/learn) - create your first generated `AppConfig`.
- [Adapters - Realtime](/docs/infrastructure/realtime) - configure the server-side transport behind live queries.
