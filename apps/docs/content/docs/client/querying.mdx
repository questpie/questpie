...
<Callout type="info">See [Query Operators Reference](/docs/reference/query-operators) for the complete per-field-type operator list.</Callout>
...
<Cards>
  <Card title="CRUD API" href="/docs/reference/crud-api" description="Full method reference — find, create, update, delete, versions" />
  <Card title="Fields" href="/docs/collections/fields" description="Field types determine available operators" />
  <Card title="Relations" href="/docs/collections/relations" description="Relation queries" />
  <Card title="Type Inference" href="/docs/client/type-inference" description="Query types" />
</Cards>
