...
<Cards>
  ...
  <Card title="Realtime Client" href="/docs/client/realtime" description="Live subscriptions" />
  <Card title="Type Inference" href="/docs/client/type-inference" description="End-to-end types" />
</Cards>
