---
title: OpenAPI
description: Generate OpenAPI 3.1 specs and interactive API docs from your app
---
...
|---|---|---|---|
| `app` | `Questpie` | — | app instance (required) |
...
- **Functions** — Input/output schemas from Zod definitions
...
- **Missing functions directory** — Without `fn()` definitions in your `functions/` directory, custom procedures won't appear in the spec.
