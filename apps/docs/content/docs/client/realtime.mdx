...
For Cloudflare Workers, use `cloudflareRealtimeAdapter` from `questpie/adapters/cloudflare` and mount the Worker with `createCloudflareWorkerHandlers`. See [Deployment](/docs/infrastructure/deployment) for the full Worker and Wrangler setup.

## Related Pages

<Cards>
  <Card title="TanStack Query" href="/docs/client/tanstack-query" description="Data fetching hooks" />
  <Card title="Realtime (Production)" href="/docs/infrastructure/realtime" description="Infrastructure setup" />
</Cards>
