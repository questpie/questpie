...
- [First App](/docs/getting-started/quickstart) — Minimal getting started
- [Collections](/docs/collections) — Collection API
- [Typed Routes](/docs/server/routes) — Typed JSON route handlers
- [Dashboard](/docs/admin/views/dashboard) — Dashboard widgets
