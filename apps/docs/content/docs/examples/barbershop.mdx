...
| Visual Edit Workspace (V2)               | `pages.ts` → `.preview()` + `v.visualEditForm` with `visualEdit.group` field metadata |
...
- [Live Preview](/docs/workspace/live-preview) — Preview overview (V1 split view + V2 workspace)
