...
<Cards>
  <Card title="First App" href="/docs/getting-started/quickstart" description="Minimal getting started" />
  <Card title="Collections" href="/docs/collections" description="Collection API" />
  <Card title="Typed Routes" href="/docs/server/routes" description="Typed JSON route handlers" />
