...
- **[Live Preview](/docs/workspace/live-preview)** — Iframe preview pipeline; default refresh-on-save plus the opt-in **[Visual Edit Workspace](/docs/workspace/live-preview/visual-edit)** (canvas + contextual inspector with field-level patches)
