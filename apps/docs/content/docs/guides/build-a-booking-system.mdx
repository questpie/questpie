...
// Functions live in the functions/ directory — no router needed.
// functions/booking/getAvailableSlots.ts exports the fn() above
// functions/booking/createBooking.ts exports the fn() above
```
