...
- [Sandboxed code](/docs/infrastructure/sandbox) covers isolated execution for application-owned workloads. You do not need a framework-owned agent runtime to expose MCP to Claude or an IDE.
