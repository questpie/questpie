...
<Callout type="info" title="Prerequisites">
	Read [Routes](/docs/concepts/routes) and [Access
...
<Callout type="info" title="`meta.mcp` is declared on the route, not here">
	...
	[Routes](/docs/concepts/routes) page. It is kept structural so the framework
...
>
	...
	over OAuth 2.1](/docs/integrations/mcp-oauth). See [Access
