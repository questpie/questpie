...
It is deliberately generic. It is not a page builder and not a website CMS. Its
job is to let the people who own the data work with it in a normal interface,
instead of opening a database client or keeping the real numbers in a
spreadsheet.
...
**[Build your first app](/docs/getting-started/tanstack-start)** scaffolds a
project, starts a database, and puts the admin screen in front of you.
