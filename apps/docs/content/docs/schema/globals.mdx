...
See [Fields](/docs/schema/fields) for the full field catalog and [Relations](/docs/schema/relations) for `f.upload()` / `f.relation()`.
...
- [Fields](/docs/schema/fields), the field catalog used by `.fields()`.
