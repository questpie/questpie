...
| `seeds`       | [Seeds](/docs/concepts/seeds).                                | **concatenated**                          |
...
A few categories don't override, they **accumulate**: `migrations` and [seeds](/docs/concepts/seeds) are concatenated across all modules, and `messages` are deep-merged per locale (a later module overrides individual keys, not the whole locale).
...
- [Seeds](/docs/concepts/seeds), bootstrap and demo data a module can contribute.
