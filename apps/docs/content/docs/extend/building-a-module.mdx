...
<Cards>
  <Card title="Modules" href="/docs/concepts/modules-and-plugins" description="Module architecture" />
  <Card title="Plugin API" href="/docs/reference/plugin-api" description="Codegen plugin reference" />
  <Card title="Custom Fields" href="/docs/extend/custom-fields" description="Custom field types" />
</Cards>
