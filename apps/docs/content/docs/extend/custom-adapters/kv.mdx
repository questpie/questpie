...
- [MemoryKVAdapter](https://github.com/questpie/questpie/blob/main/packages/questpie/src/server/modules/core/integrated/kv/adapters/memory.ts) -- in-memory Map with TTL and tag support
- [RedisKVAdapter](https://github.com/questpie/questpie/blob/main/packages/questpie/src/server/modules/core/integrated/kv/adapters/redis.ts) -- Redis via a node-redis compatible client, tag invalidation via Redis SETs
- [KVAdapter interface source](https://github.com/questpie/questpie/blob/main/packages/questpie/src/server/modules/core/integrated/kv/adapter.ts)
