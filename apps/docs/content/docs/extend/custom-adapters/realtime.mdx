...
import type { RealtimeNotice } from "questpie/realtime";
...
- [PgNotifyAdapter](https://github.com/questpie/questpie/blob/main/packages/questpie/src/server/modules/core/integrated/realtime/adapters/pg-notify.ts) -- PostgreSQL LISTEN/NOTIFY, JSON over a single channel
- [RedisStreamsAdapter](https://github.com/questpie/questpie/blob/main/packages/questpie/src/server/modules/core/integrated/realtime/adapters/redis-streams.ts) -- Redis Streams with consumer groups, batched reads
- [RealtimeAdapter interface source](https://github.com/questpie/questpie/blob/main/packages/questpie/src/server/modules/core/integrated/realtime/adapter.ts)
