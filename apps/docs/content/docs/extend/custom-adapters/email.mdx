...
QUESTPIE already ships built-in `ResendAdapter` and `PlunkAdapter`. This example shows the same shape for a custom HTTP provider.
...
- [ConsoleAdapter](https://github.com/questpie/questpie/blob/main/packages/questpie/src/server/modules/core/integrated/mailer/adapters/console.adapter.ts) -- logs emails to console, useful for development
- [SmtpAdapter](https://github.com/questpie/questpie/blob/main/packages/questpie/src/server/modules/core/integrated/mailer/adapters/smtp.adapter.ts) -- production SMTP via nodemailer, includes `createEtherealSmtpAdapter()` helper for test accounts
- [ResendAdapter](https://github.com/questpie/questpie/blob/main/packages/questpie/src/server/modules/core/integrated/mailer/adapters/resend.adapter.ts) -- HTTP adapter for Resend and Resend-compatible APIs
- [PlunkAdapter](https://github.com/questpie/questpie/blob/main/packages/questpie/src/server/modules/core/integrated/mailer/adapters/plunk.adapter.ts) -- HTTP adapter for Plunk transactional email
- [MailAdapter base class source](https://github.com/questpie/questpie/blob/main/packages/questpie/src/server/modules/core/integrated/mailer/adapter.ts)
