...
flowchart TD
  ...
  Registry["Plugin Registry<br/>categories, discover patterns, builder extensions, callback params, singleton factories"]
  Targets["Target Graph Resolution<br/>server, admin-client, etc."]
  Discovery["File Discovery<br/>scan directories, match patterns, detect exports, derive keys"]
  Transforms["Transforms<br/>plugin order modifies imports, types, runtime code"]
  Emission["Template Emission"]
  Index["index.ts or module.ts"]
  Factories["factories.ts"]
  Registries["registries.ts"]

  Config --> Registry --> Targets --> Discovery --> Transforms --> Emission
  Emission --> Index
  Emission --> Factories
  Emission --> Registries
```
...
```mermaid
flowchart TD
  Root["packages/admin/src/server/modules/"]
  Admin["admin/"]
  AdminGenerated[".generated/"]
  AdminModule["module.ts<br/>server target"]
  AdminRegistries["registries.ts<br/>type augmentation"]
  AdminClient["client/"]
  AdminClientGenerated[".generated/"]
  AdminClientModule["module.ts<br/>admin-client target"]
  Audit["audit/"]
  AuditModule[".generated/module.ts"]
  Preferences["admin-preferences/"]
  PreferencesModule[".generated/module.ts"]

  Root --> Admin
  Admin --> AdminGenerated
  AdminGenerated --> AdminModule
  AdminGenerated --> AdminRegistries
  Admin --> AdminClient --> AdminClientGenerated --> AdminClientModule
  Root --> Audit --> AuditModule
  Root --> Preferences --> PreferencesModule
```
...
<Cards>
  <Card title="File Convention" href="/docs/concepts/file-convention" description="What files are discovered" />
  <Card title="Building a Plugin" href="/docs/extend/building-a-plugin" description="Creating your own plugin" />
  <Card title="Building a Module" href="/docs/extend/building-a-module" description="Creating reusable modules" />
  <Card title="Registries" href="/docs/extend/registries" description="Type registry system" />
</Cards>
