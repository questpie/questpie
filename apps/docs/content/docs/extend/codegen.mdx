...
Codegen is driven by three commands. The broader migrate / seed / push surface is covered by [Configuration](/docs/concepts/configuration) and [Seeds](/docs/schema/seeds).
