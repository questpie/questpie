...
<Cards>
  <Card title="List Views" href="/docs/admin/views/list-views" description="Built-in list views" />
  <Card title="Form Views" href="/docs/admin/views/form-views" description="Built-in form views" />
  <Card title="Admin API" href="/docs/reference/admin-api" description="Admin client factories" />
</Cards>
