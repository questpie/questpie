...
flowchart TD
  ...
  React["React<br>#lt;TextFieldRenderer value={...} onChange={...} /#gt;"]
...
<Cards>
  <Card title="Custom Fields" href="/docs/extend/custom-fields" description="Creating field types" />
  <Card title="Custom Views" href="/docs/extend/custom-views" description="Creating view types" />
