...
<Cards>
  <Card title="Fields" href="/docs/collections/fields" description="Built-in field types" />
  <Card title="Building a Module" href="/docs/extend/building-a-module" description="Package as a module" />
