...
- [Jobs](/docs/server/jobs) — Defining job handlers
- [Services](/docs/server/services) — Reusable business logic used by jobs
- [Email](/docs/infrastructure/email) — Sending emails from jobs
