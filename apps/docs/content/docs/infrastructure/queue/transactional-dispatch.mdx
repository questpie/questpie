...
| `idempotencyKey`, `singletonKey`, `PublishOptions` | [Jobs](/docs/code/jobs#publishoptions)                                       |
| Reading a dispatch receipt                         | [Secret payloads](/docs/code/jobs#secret-bearing-payloads-and-safe-receipts) |
