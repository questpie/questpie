...
<Cards>
  <Card title="Deployment" href="/docs/infrastructure/deployment" description="Production setup" />
  <Card title="Config API" href="/docs/reference/config-api" description="Application configuration" />
</Cards>
