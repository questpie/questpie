...
applications often need to send emails — appointment confirmations, password resets, notifications. QUESTPIE's email system lets you define type-safe templates and send them through `app.email`.
