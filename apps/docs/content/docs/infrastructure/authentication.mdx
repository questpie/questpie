...
<Callout type="warn">
Do not replace `collection("user")` from scratch in an app that uses `adminModule`. If you need custom user fields or admin layout, merge the starter user collection and extend it instead.
</Callout>
...
<Cards>
  <Card title="Access Control" href="/docs/collections/access-control" description="Permission rules" />
  <Card title="Admin Setup" href="/docs/admin/setup" description="Admin auth pages" />
</Cards>
