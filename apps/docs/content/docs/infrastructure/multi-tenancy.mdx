...
sequenceDiagram
	...
	participant Server as "context.ts"
	...
	Server->>Access: Expose workspaceId in typed context
	Access->>Data: Apply { workspace: { equals: "ws_123" } }
...
<Cards>
  <Card title="Access Control" href="/docs/collections/access-control" description="Where-clause filters and role-based rules" />
  <Card title="Services" href="/docs/server/services" description="Request-scoped services for tenant isolation" />
  <Card title="Authentication" href="/docs/infrastructure/authentication" description="Session-based auth with Better Auth" />
</Cards>
