...
- [Access Control](/docs/collections/access-control) — where-clause filters and role-based rules
- [Services](/docs/server/services) — request-scoped services for tenant isolation
- [Authentication](/docs/infrastructure/authentication) — session-based auth with Better Auth
