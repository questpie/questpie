...
<Cards>
  <Card title="Database" href="/docs/infrastructure/database" description="PostgreSQL setup" />
  <Card title="Migrations" href="/docs/infrastructure/migrations" description="Schema management" />
</Cards>
