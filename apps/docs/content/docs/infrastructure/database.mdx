...
<Cards>
  <Card title="Migrations" href="/docs/infrastructure/migrations" description="Schema versioning" />
  <Card title="Collections" href="/docs/collections" description="Data models" />
</Cards>
