...
See [Built-in Actions](/docs/admin/actions/builtin) for details.
...
See [Custom Actions](/docs/admin/actions/custom) for the full guide.

## Sections

- [Built-in Actions](/docs/admin/actions/builtin) — Create, save, delete, duplicate
- [Custom Actions](/docs/admin/actions/custom) — Custom forms and handlers
