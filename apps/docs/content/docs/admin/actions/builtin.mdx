...
For stage configuration, transition access rules, hooks, stage reads, and scheduled transitions, see [Versioning & Workflow](/docs/collections/versioning).
...
<Cards>
  <Card title="Custom Actions" href="/docs/admin/actions/custom" description="Define your own actions" />
  <Card title="Versioning & Workflow" href="/docs/collections/versioning" description="Configure draft and publishing stages" />
  <Card title="Access Control" href="/docs/collections/access-control" description="Permission rules" />
  <Card title="Bulk Actions" href="/docs/admin/bulk-actions" description="Multi-select operations" />
</Cards>
