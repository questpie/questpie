...
- [Custom Actions](/docs/admin/actions/custom) — Define your own actions
- [Versioning & Workflow](/docs/collections/versioning) — Configure draft and publishing stages
- [Access Control](/docs/collections/access-control) — Permission rules
- [Bulk Actions](/docs/admin/bulk-actions) — Multi-select operations
