...
<Cards>
  ...
  <Card title="Actions" href="/docs/admin/actions" description="Custom and built-in actions" />
  <Card title="Filters" href="/docs/admin/filters" description="Filtering records" />
</Cards>
