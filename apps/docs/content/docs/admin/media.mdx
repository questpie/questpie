...
See [Storage](/docs/infrastructure/storage) for S3, local, and other backends.
...
<Cards>
  ...
  <Card title="Storage" href="/docs/infrastructure/storage" description="Storage backend setup" />
</Cards>
