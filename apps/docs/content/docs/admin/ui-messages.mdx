...
- [Content Languages](/docs/collections/localization) — Configure localized record values
- [Workspace Localization](/docs/admin/localization) — Editor-facing content locale switcher
- [Admin API](/docs/reference/admin-api) — `adminConfig()` reference
- [File Convention](/docs/concepts/file-convention) — `messages/` discovery
