...
<Cards>
  <Card title="Renderers" href="/docs/admin/blocks/renderers" description="React components for blocks" />
  <Card title="Prefetch" href="/docs/admin/blocks/prefetch" description="Prefetching relation data" />
