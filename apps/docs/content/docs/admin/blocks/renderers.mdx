...
<Cards>
  <Card title="Defining Blocks" href="/docs/admin/blocks/defining-blocks" description="Server-side definitions" />
  <Card title="Prefetch" href="/docs/admin/blocks/prefetch" description="Loading relation data" />
  <Card title="Live Preview" href="/docs/admin/live-preview" description="FormView, iframe, and protocol overview" />
</Cards>
