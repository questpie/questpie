...
- [Sidebar](/docs/admin/views/sidebar) — Navigation structure
- [Setup](/docs/admin/setup) — Admin panel setup
- [Localization](/docs/admin/localization) — UI locale configuration
