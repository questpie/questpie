...
<Cards>
  <Card title="Sidebar" href="/docs/admin/views/sidebar" description="Navigation structure" />
  <Card title="Setup" href="/docs/admin/setup" description="Admin panel setup" />
  <Card title="Localization" href="/docs/admin/localization" description="UI locale configuration" />
</Cards>
