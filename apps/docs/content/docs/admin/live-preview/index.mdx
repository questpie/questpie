...
For a complete page setup, see [Prepare a Page](/docs/admin/live-preview/prepare-page).
...
<Cards>
  <Card title="Prepare a Page" href="/docs/admin/live-preview/prepare-page" description="Collection config, loaders, frontend preview wiring, and annotations" />
  <Card title="Architecture" href="/docs/admin/live-preview/architecture" description="Source-of-truth model and boundaries" />
  <Card title="Protocol Reference" href="/docs/admin/live-preview/protocol" description="Message contract, diagrams, and security rules" />
  <Card title="Blocks" href="/docs/admin/blocks" description="Block content and renderer annotations" />
  <Card title="Versioning & Workflow" href="/docs/collections/versioning" description="Stage reads and transitions" />
</Cards>
