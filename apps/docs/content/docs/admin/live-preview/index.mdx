...
- [Prepare a Page](/docs/admin/live-preview/prepare-page) — collection config, loaders, frontend preview wiring, and annotations
- [Architecture](/docs/admin/live-preview/architecture) — source-of-truth model and boundaries
- [Protocol Reference](/docs/admin/live-preview/protocol) — message contract, diagrams, and security rules
- [Blocks](/docs/admin/blocks) — block content and renderer annotations
- [Versioning & Workflow](/docs/collections/versioning) — stage reads and transitions
