...
- [Localized Fields](/docs/collections/localization) — Server-side localization setup
- [UI Language & Messages](/docs/admin/ui-messages) — Admin interface locale and translation keys
- [Fields](/docs/collections/fields) — Field types and `.localized()`
- [Form Views](/docs/admin/views/form-views) — Form layout and toolbar
