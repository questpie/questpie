...
<Cards>
  <Card title="Localized Fields" href="/docs/collections/localization" description="Server-side localization setup" />
  <Card title="UI Language & Messages" href="/docs/admin/ui-messages" description="Admin interface locale and translation keys" />
  <Card title="Fields" href="/docs/collections/fields" description="Field types and `.localized()`" />
  <Card title="Form Views" href="/docs/admin/views/form-views" description="Form layout and toolbar" />
</Cards>
