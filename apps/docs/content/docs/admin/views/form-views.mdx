...
| `deps`     | `(ctx) => unknown[]` | Reactive dependencies    |
...
See [Visibility](/docs/admin/visibility) for more patterns.
...
<Cards>
  <Card title="List Views" href="/docs/admin/views/list-views" description="Table configuration" />
  <Card title="Visibility" href="/docs/admin/visibility" description="Reactive visibility rules" />
  <Card title="Fields" href="/docs/collections/fields" description="Field types" />
</Cards>
