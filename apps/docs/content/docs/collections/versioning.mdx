...
- [Collections](/docs/collections) — Collection builder options
- [Globals](/docs/collections/globals) — Global builder options
- [Hooks API](/docs/reference/hooks-api) — Transition hook context
- [Built-in Actions](/docs/admin/actions/builtin) — Admin toolbar actions
