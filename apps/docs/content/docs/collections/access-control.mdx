...
- [Hooks](/docs/collections/hooks) — Lifecycle hooks for custom logic
- [Validation](/docs/collections/validation) — Input validation
- [Authentication](/docs/infrastructure/authentication) — Session and auth setup
