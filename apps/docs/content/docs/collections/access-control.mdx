...
<Cards>
  <Card title="Hooks" href="/docs/collections/hooks" description="Lifecycle hooks for custom logic" />
  <Card title="Validation" href="/docs/collections/validation" description="Input validation" />
  <Card title="Authentication" href="/docs/infrastructure/authentication" description="Session and auth setup" />
</Cards>
