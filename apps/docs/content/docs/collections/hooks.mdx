...
- [Validation](/docs/collections/validation) — Field-level validation
- [Access Control](/docs/collections/access-control) — Operation permissions
- [Jobs](/docs/server/jobs) — Background tasks triggered by hooks
- [Typed Routes](/docs/server/routes) — Server-side business logic
