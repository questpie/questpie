...
<Cards>
  <Card title="Fields" href="/docs/collections/fields" description="Field types and constraints" />
  <Card title="Hooks" href="/docs/collections/hooks" description="Lifecycle hooks" />
  <Card title="Access Control" href="/docs/collections/access-control" description="Operation-level rules" />
</Cards>
