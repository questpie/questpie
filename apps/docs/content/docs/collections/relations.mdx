...
<Cards>
  <Card title="Fields" href="/docs/collections/fields" description="All field types" />
  <Card title="Collections" href="/docs/collections" description="Collection builder" />
  <Card title="Querying" href="/docs/client/querying" description="Query operators and patterns" />
</Cards>
