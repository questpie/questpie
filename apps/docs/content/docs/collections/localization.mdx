...
Use this page for content languages. For admin interface language and message keys, see [UI Language & Messages](/docs/admin/ui-messages).
...
<Cards>
  <Card title="Workspace Localization" href="/docs/admin/localization" description="How editors switch content locale in the admin" />
  <Card title="UI Language & Messages" href="/docs/admin/ui-messages" description="Admin interface locale and message keys" />
  <Card title="Fields" href="/docs/collections/fields" description="Field types and `.localized()`" />
  <Card title="Globals" href="/docs/collections/globals" description="Site-wide localized settings" />
</Cards>
