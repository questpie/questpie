...
- [Workspace Localization](/docs/admin/localization) — How editors switch content locale in the admin
- [UI Language & Messages](/docs/admin/ui-messages) — Admin interface locale and message keys
- [Fields](/docs/collections/fields) — Field types and `.localized()`
- [Globals](/docs/collections/globals) — Site-wide localized settings
