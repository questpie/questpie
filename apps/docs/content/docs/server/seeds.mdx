...
<Cards>
  ...
  <Card title="Services" href="/docs/server/services" description="Reusable logic" />
  <Card title="CLI" href="/docs/reference/cli" description="All CLI commands" />
  <Card title="Codegen" href="/docs/concepts/codegen" description="How seeds are discovered" />
</Cards>
