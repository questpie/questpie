...
- [Typed Routes](/docs/server/routes) — Use services in route handlers
- [Hooks](/docs/collections/hooks) — Use services in lifecycle hooks
- [Jobs](/docs/server/jobs) — Publish background work from services
- [Codegen](/docs/concepts/codegen) — How services appear in AppContext
