---
title: Server
description: Core schema layer — collections, globals, fields, hooks, access, and functions
---
...
config (Configuration)
  ...
  ├── functions/                → typed server functions (file convention)
  ├── modules: [adminModule]    → extension modules
...
export default [adminModule] as const;  // adds .admin(), .list(), .form() to collections
```
...
**Functions** let you define typed server procedures alongside your collections, with Zod input validation and full access to the typed context.
...
- [Modules & Extensions](/docs/server/modules-and-extensions) — File convention, codegen, and module composition
...
- [Type-Safe Contexts](/docs/server/type-safe-contexts) — End-to-end typing for hooks, access, functions, jobs, and services
