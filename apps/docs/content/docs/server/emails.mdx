...
<Cards>
  ...
  <Card title="Jobs" href="/docs/server/jobs" description="Send emails from background jobs" />
  <Card title="Hooks" href="/docs/collections/hooks" description="Send emails from lifecycle hooks" />
</Cards>
