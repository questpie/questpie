...
- [Email Infrastructure](/docs/infrastructure/email) — Mailer adapter configuration
- [Jobs](/docs/server/jobs) — Send emails from background jobs
- [Hooks](/docs/collections/hooks) — Send emails from lifecycle hooks
