...
flowchart LR
  ...
  Stripe["routes/webhooks/stripe.ts"]
  Github["routes/webhooks/github.ts"]
  Export["routes/export.ts"]
  HealthUrl["/api/health"]
  StripeUrl["/api/webhooks/stripe"]
...
<Cards>
  ...
  <Card title="Jobs" href="/docs/server/jobs" description="Background processing" />
  <Card title="File Convention" href="/docs/concepts/file-convention" description="Discovery rules" />
</Cards>
