...
export function buildEntrySource(appSource: string, fnName: string): string {
	...
	return [
		...
		`  const __actions = (__mod.actions && typeof __mod.actions === "object") ? __mod.actions : null;`,
		`  const __fn = __FN === "default" ? __mod.default`,
		`    : (__actions && typeof __actions[__FN] === "function") ? __actions[__FN] : __mod[__FN];`,
